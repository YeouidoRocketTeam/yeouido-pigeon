              ...
              parameters: {
                ...
                properties: {
                  ...
                  investment_sentiment: {
                    ...
                    description: "Investment sentiment judgment. positive=강세 (earnings improvement, contract wins, target price increase, policy benefits, new business momentum), neutral=중립 (simple fact delivery, mixed signals, unclear direction), negative=약세 (earnings decline, target price downgrade, regulatory risk, intensified competition, large losses/lawsuits)",
                  },
                },
                required: ["ai_title", "ai_summary", "source_type", "reliability_score", "themes", "stocks", "investment_sentiment"],
